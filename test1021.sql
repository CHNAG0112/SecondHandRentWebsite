...
(34, 1, '鋼之煉金術師', '神作推廣，此生必看漫畫。', '已上架', '2022-10-02', 8, NULL, 10301),
...
(73, 1, '文學少女全套', '神作推廣', '已下架', '2022-10-17', 2, 10, 20312),
(74, 1, '黃金神威', '故事以明治末期的北海道為舞台，描述前軍人「不死身」杉元佐一和阿伊努族少女阿席莉帕的尋找黃金的戰鬥冒險故事，\r\n並融合了明治末期的北海道之史地文化及建築、阿伊努文化、阿伊努語言風俗、野外生存、狩獵、美食、軍武戰爭等要素都有豐富的描寫與介紹。', '已上架', '2022-10-21', 9, NULL, 10301);
...
(1, '許靖', '$2a$10$ufLzH9Vivn3redb4RW0av.J.MGDWQE0yvgla1MRu80SEpIhNCYuZ2', 'Kiara@gmail.com', '912345678', '', '', NULL, '20221021100800_03.jpg', '許靖', '', '一般', '', '1', NULL, '2022-10-06 11:36:05', '2022-10-21 16:06:12', '7-ELEVEN 墩隆門市', 'OK 台中太原店', '全家 台中樂活店', '2222222'),
...
(7, '羅紹旗', '$2a$10$ufLzH9Vivn3redb4RW0av.J.MGDWQE0yvgla1MRu80SEpIhNCYuZ2', 'Subaru12', NULL, NULL, NULL, NULL, '2.jpg', '紹旗', NULL, '2', NULL, NULL, NULL, '2022-10-06 11:58:26', '2022-10-21 15:06:35', '7-ELEVEn 中川門市 便利商店', 'OK便利商店 台中太原店', '全家便利商店 台中樂活店', '1875646298651422'),
...
(95, 69, 73, '2022-10-23', '', '全家便利商店 台中樂活店', '2022-11-05', '', '全家 台中樂活店', 2, NULL, NULL, '同意續借', '信用卡4311952222222222'),
(97, 71, 34, '2022-10-30', NULL, 'OK便利商店 台中太原店', '2022-11-05', NULL, 'OK 台中太原店', 8, NULL, NULL, '已接受/出貨中', '信用卡4311952222222222');
...
(69, 7, '2022-10-21', NULL, NULL, 16, '20221021PR00851498', NULL),
(71, 7, '2022-10-21', NULL, NULL, 48, '20221021PR00105732', NULL);
...
--
ALTER TABLE `items`
  MODIFY `item_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `item_picture`
--
ALTER TABLE `item_picture`
  MODIFY `picture_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
...
--
ALTER TABLE `order_details`
  MODIFY `order_detail_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
